class Fatura:
    ...
    def __init__(self, num_item, descricao, quantidade=0, preco_unitario=0):   #Definindo O Metodo Construtor e os Argumentos !
    ...
    @num_item.setter                #Encapsulamento com o metado setter !
